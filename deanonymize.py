...
def link_records(anon_file, aux_file):
    """
    Link anonymized records to auxiliary records using
    age, zip3, and gender as quasi-identifiers.

    Returns a dataframe containing the predicted matches.
    """
...
def calculate_success_rate(linked_df):
    """
    Calculate the deanonymization success rate.
    """
...
def main():
    """
    Run the deanonymization experiment.
    """
